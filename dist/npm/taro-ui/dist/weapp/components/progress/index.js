...
var AtProgress = (_temp2 = _class = function (_AtComponent) {
  ...
  function AtProgress() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtProgress.__proto__ || Object.getPrototypeOf(AtProgress)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "rootClass", "isHidePercent", "status", "iconInfo", "percent", "color", "strokeWidth", "className"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AtProgress, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp2 = !isHidePercent ? { fontSize: '18px' } : null;
