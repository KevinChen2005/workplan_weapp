...
var AtSwitch = (_temp2 = _class = function (_AtComponent) {
  ...
  _createClass(AtSwitch, [{
    ...
    value: function handleChange(e) {
      this.__triggerPropsFn("onChange", [null].concat([e.detail.value].concat(Array.prototype.slice.call(arguments))));
    }
  }, {
    key: "_createData",
...
}, _class.$$events = ["handleChange"], _class.defaultProps = {
  customStyle: '',
  className: '',
  title: '',
  color: '#6190e8',
