...
var AtActionSheetBody = (_temp2 = _class = function (_AtComponent) {
  ...
  function AtActionSheetBody() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtActionSheetBody.__proto__ || Object.getPrototypeOf(AtActionSheetBody)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["rootClass", "className", "children"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AtActionSheetBody, [{
    ...
    value: function _createData() {
      ...
      var rootClass = (0, _index4.default)('at-action-sheet-body', this.__props.className);
