...
var AtTimeline = (_temp2 = _class = function (_AtComponent) {
  ...
  function AtTimeline() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtTimeline.__proto__ || Object.getPrototypeOf(AtTimeline)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp3", "anonymousState__temp4", "loopArray0", "items", "pending", "customStyle", "className"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AtTimeline, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp3 = (0, _index6.default)(rootClassName, rootClassObject, this.__props.className);
      var anonymousState__temp4 = (0, _index3.internal_inline_style)(customStyle);
      var loopArray0 = items.map(function (item, index) {
        item = {
        ...
        var itemRootClassName = ['at-timelineitem'];
        if (color) {
          itemRootClassName.push("at-timelineitem--" + color);
        }var dotClass = ['at-timelineitem__dot'];
        if (icon) {
          dotClass.push('at-timelineitem__icon');
        }var $loopState__temp2 = icon ? { fontSize: '16px' } : null;
        return {
          color: color,
          icon: icon,
          title: title,
