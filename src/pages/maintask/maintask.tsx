    ...
    return (
      <View className='index'>
        <View className='tasktitle'>
           <AtIcon value='add' className='titleelement' size='30' color='#888' onClick={this.showaddmodel}></AtIcon>
        <View className='titleelement'>
           <AtSwitch border={false}   onChange={this.changelockstate} customStyle='padding:0 0 0 0;' checked={this.state.locktaskstate} title='锁定' />
        </View>
        </View> 
